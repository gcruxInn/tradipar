...
public class PostPartnersPJ implements ScheduledAction {
    ...
    public void onTime(ScheduledActionContext ctx) {
        ...
        try {
            ...
            sql.appendSql("SELECT\r\n"
            		...
            		+ "WHERE PAR.TIPPESSOA = 'J' AND ROWNUM < 300");
            ...
            while (rs.next()) {
                ...
                properties.put("razao_social", v(razao));
                properties.put("name", v(nome));
                properties.put("cnpj", v(cnpj));
                ...
                properties.put("limite_credito", limCred);
