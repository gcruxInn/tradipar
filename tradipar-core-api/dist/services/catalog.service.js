...
class CatalogService {
     ...
     */
    async enrichProductsWithStock(products) {
        try {
    ...
    async executeSankhyaQuery(sql) {
        ...
        const resp = await sankhya_api_1.sankhyaApi.post('/gateway/v1/mge/service.sbr?serviceName=DbExplorerSP.executeQuery&outputType=json', payload);
